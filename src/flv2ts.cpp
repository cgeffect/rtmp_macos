...
int main(int argc, char *argv[]) {
    const char *inputFLV = "/Users/jason/Jason/webrtc/native-rtc/rtmp_macos/test2.flv";
    const char *outputTS = "/Users/jason/Jason/webrtc/native-rtc/rtmp_macos/flv2ts.ts";
    flv2ts_test(inputFLV, outputTS);
    return 0;
}