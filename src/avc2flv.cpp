...
int main(int argc, char *argv[]) {
    const char *inputH264 = "/Users/jason/Jason/webrtc/native-rtc/rtmp_macos/test2.h264";
    const char *outputFLV = "/Users/jason/Jason/webrtc/native-rtc/rtmp_macos/avc2flv.flv";
